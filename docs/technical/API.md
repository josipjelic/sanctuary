...
> **Last updated**: 2026-07-13 (removed journal-next-question + journal-save-session; AI-Guided Journal reverted, ADR-007)
...
| 2026-07-13 | Removed `POST /journal-next-question` and `POST /journal-save-session` — AI-Guided Journal feature reverted (ADR-007); `phase`/`function` lists trimmed accordingly |
